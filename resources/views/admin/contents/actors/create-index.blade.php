...
@section('content')
    <div class="form-group row bg-white pb-4">
        ...
        <div class="col-md-12">
            {!! Form::open(array('url' => ['admin/actors'], 'method' => 'POST')) !!} 
            {!! csrf_field() !!}
            <div class="container mt-5">
                <div class="col-md-12">
                    <h3><i class="fas fa-edit"></i> Tạo mới diễn viên</h3>
                </div>
            <div class="form-group border-0 shadow">
                    <div class="card">
                        <div class="card-header bg-dark text-white text-uppercase font-weight-bold">
                            Tạo mới diễn viên
                        </div>
                        <div class="card-body">
                            <div class="container">
                                <div class="form-row">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-check-input" type="radio" name="job1" id="" value="option1" checked>
                                    <label class="form-check-label" for="job">
                                    Đạo diễn
                                    </label>
                                    </div>
                                    <div class="form-check">
                                    <input class="form-check-input" type="radio" name="job2" id="" value="option2">
                                    <label class="form-check-label" for="job">
                                    Diễn viên
                                    </label>
                                    </div>                                
