...
@section('title','Quản lý đạo diễn') 
...
@section('content')
    <div class="form-group row bg-white pb-4">
        ...
        <div class="col-md-12">
            {!! Form::model($directors,array('route' => array('directors.update',$directors->id),'method' => 'PUT')) !!}
            {!! csrf_field() !!}
            <div class="container mt-5">
                <div class="form-group row">
                    <div class="col-md-12">
                        <h3><i class="fas fa-edit"></i> Sửa thông tin đạo diễn</h3>
                    </div>
                </div>
                                ...
                                <div class="form-group">
                                    <div class="row ml-0">
                                        ...
                                        <div class="custom-control custom-switch ml-4">
                                            <input type="checkbox" name="status" class="custom-control-input" id="status" {{($directors->status != null) ? 'checked value=1':'value=0'}}>
                                            {{Form::label('status', ($directors->status != null) ? 'Công khai':'Tạm ẩn', ['class' => 'custom-control-label'])}}
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="form-group">
                    ...
                    <a href="{{ route('directors.index') }}" class="btn btn-light btn-outline-dark b-r-xs">Hủy</a>
                </div>
            </div>
            {!! Form::close() !!}
        </div>
