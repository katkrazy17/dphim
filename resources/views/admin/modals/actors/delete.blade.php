<div class="modal fade" id="Delete-{{$actor->id}}" tabindex="-1" role="dialog"
        ...
        <div class="modal-content text-center border border-danger">
            <div class="modal-body">
                ...
                <div class="row d-flex justify-content-center">
                    <h3 class="text-danger">[ {{ $actor->full_name}} ]</h3>
                </div>
            ...
            <div class="modal-footer d-flex justify-content-center">
                {!! Form::open(['method' => 'Delete', 'route' => ['actors.destroy', $actor->id]]) !!}
